...
Feature: OpenCart Authentication - Login Page Security
  ...
  @JAS-92 @JAV-LPS-001 @security @REQ-LPS-001
  ...
  @JAS-114 @JAV-LPS-002 @security @REQ-LPS-002
  Scenario: Login page is served over HTTPS
    Then the login page URL should use HTTPS

  @JAS-112 @JAV-LPS-003 @security @negative @REQ-LPS-003
  ...
  @JAS-113 @JAV-LPS-004 @security @negative @REQ-LPS-004
