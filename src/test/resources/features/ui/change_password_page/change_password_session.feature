...
Feature: OpenCart Account - Change Password Session Management
  ...
  @JAV-CPSE-001 @session @positive @REQ-CPSE-001
  ...
  @JAV-CPSE-002 @session @security @REQ-CPSE-002
  ...
  @JAV-CPSE-003 @session @stability @REQ-CPSE-003
  ...
  @JAV-CPSE-004 @session @navigation @REQ-CPSE-004
